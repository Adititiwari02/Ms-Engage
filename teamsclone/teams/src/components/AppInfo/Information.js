                        ...
                        <div className="row" style={{ textAlign: "center" }}>
                            <div className="col-sm" style={styleObj}>
                                <div>
                                    ...
                                    <p>
                                        Fully functional video call with audio
                                        and video controlls as well as share
                                        screen option
                                    </p>
                                    <p>
                                        There is an option to have group video
                                        call without creating groups as well
                                    </p>
                                </div>
                            </div>
                            <div className="col-sm" style={styleObj}>
                                <div>
                                    ...
                                    <p>
                                        You can see all the users of the app and
                                        send/accept connection requests, later
                                        on with these connected users you can
                                        form groups
                                    </p>
                                </div>
                            </div>
                            <div className="col-sm" style={styleObj}>
                                <div>
                                    ...
                                    <p>
                                        A group chat feature where you can have
                                        conversations before, during and after
                                        the meeting
                                    </p>
                                    <p>
                                        The video call link is also sent in the
                                        chat
                                    </p>
                                </div>
                            </div>
                            <div className="col-sm" style={styleObj}>
                                <div>
                                    ...
                                    <p>
                                        Create survey forms, respond to the and
                                        see the responses to them as well.
                                    </p>
                                    <p>
                                        The Notes section lets you store
