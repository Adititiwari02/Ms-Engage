...
import RoomWithChat from "./components/videoCall/RoomWithChat";
        ...
        <div>
            <BrowserRouter>
                <AuthProvider>
                    <Switch>
                        <Route
                            path="/call/:groupId/:roomID"
                            exact
                            component={RoomWithChat}
                        />
                        <Route
                            path="/Notes/:groupId"
                            exact
                            component={NoteCreateDelete}
                        />
                        ...
                        />
                        <PrivateRoute
                            path="/chat/feedback/:groupId/"
                            component={FeedbackForms}
                        />
                        <PrivateRoute
                            path="/chat/feedbackResults/:groupId/:formId"
                            component={FeedbackResponses}
                        />
                        <PrivateRoute
                            path="/chat/feedbackResults/:groupId/"
                            component={FeedbackResults}
                        />
                        <PrivateRoute
                            path="/chat/:groupId/:formId/"
                            component={FillForm}
                        />
